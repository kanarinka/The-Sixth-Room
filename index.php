...
<body>
  ...
  <div id="about-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer">
      <button id="sign-the-guestbook-button" class="btn btn-warning pull-right" style="margin-left:20px" data-dismiss="modal" aria-hidden="true">Sign the guestbook</button> <p>Signing the guestbook includes your name and location as part of the Sixth Room network visualization.</p>
    </div>
  </div>
  <!-- Guestbook Modal -->
  <div id="guestbook-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer">
      <button class="btn btn-info pull-left" id="guestbook-about-button">About the project</button> <button class="btn btn-info" data-dismiss="modal" aria-hidden="true">Skip the guestbook</button>
    </div>
  </div>
</body>
    ...
    $('#sign-the-guestbook-submit').click(function(){
        ...
        $.ajax({
           ...
           success: function(result){     
             $('#guestbook-form-div').text('<p>' + result + '</p>')      
           }
        });   
        return false;     
     });
